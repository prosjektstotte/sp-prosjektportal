...
<asp:Content ContentPlaceHolderID="PlaceHolderMain" runat="server">
    <div class="ms-inputformcontrols">
        <div class="ms-inputformdescription">Prosjektets navn: </div><div class="ms-inputuserfield"><input type="text" id="projectName" /></div>
        <div class="ms-inputformdescription">Prosjektets navn: </div><div class="ms-inputuserfield"><input type="text" id="projectUrlName" /></div>
    </div>
