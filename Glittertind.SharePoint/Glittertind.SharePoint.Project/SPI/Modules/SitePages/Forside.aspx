            ...
            <%@ Assembly Name="Microsoft.Web.CommandUI, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
                <%@ Register Tagprefix="WebPartPages" Namespace="Microsoft.SharePoint.WebPartPages" Assembly="Microsoft.SharePoint, Version=15.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
                    ...
                    <asp:Content ID="Content5" ContentPlaceHolderID="PlaceHolderAdditionalPageHead" runat="server">
                        ...
                        <SharePoint:ScriptLink Name="~sitecollection/SiteAssets/gt/js/gt.common.js?rev=20170327" runat="server" Language="javascript"></SharePoint:ScriptLink>
                        <SharePoint:ScriptLink Name="~sitecollection/SiteAssets/gt/js/gt.generics.js?rev=20170327" runat="server" Language="javascript"></SharePoint:ScriptLink>
                        <SharePoint:ScriptLink Name="~sitecollection/SiteAssets/gt/js/gt.project.js?rev=20170327" runat="server" Language="javascript"></SharePoint:ScriptLink>
                        <SharePoint:ScriptLink Name="~sitecollection/SiteAssets/gt/js/gt.project.setup.js?rev=20170327" runat="server" Language="javascript"></SharePoint:ScriptLink>
                        <SharePoint:ScriptLink Name="~sitecollection/SiteAssets/gt/js/gt.project.setup.contenttypes.js?rev=20170327" runat="server"
                            Language="javascript"></SharePoint:ScriptLink>
                        <SharePoint:CssRegistration Name="&lt;% $SPUrl:~sitecollection/SiteAssets/gt/css/gt.style.css?rev=20170327 %&gt;" runat="server"></SharePoint:CssRegistration>
                    </asp:Content>
                                ...
                                <td valign="top" width="70%">
                                    <div class="projectPhaseSection">
                                        <div class="projectPhaseHeading">
                                            <h2 class="ms-webpart-titleText gt-phaseHeading">
                                                <nobr><span>Prosjektets faser</span><span id="WebPartCaptionWPQ2"></span></nobr>
                                            </h2>
                                ...
                                <td valign="top" width="30%">
                                    <div class="rightColumnStatic">
                                        <h2 style="text-align:justify;" class="ms-webpart-titleText">
                                            <nobr><span>Om prosjektet</span><span id="WebPartCaptionWPQ2"></span></nobr>
                                        </h2>
                                        <div class="projectMetadata">
                                            ...
                                            <SharePoint:SPSecurityTrimmedControl runat="server" AuthenticationRestrictions="AuthenticatedUsersOnly" Permissions="AddAndCustomizePages"
                                                PermissionContext="CurrentItem">
                                                <div class="missingMetadataWarning">Viktig informasjon om prosjektet er ikke satt. Du bør sette disse egenskapene
                                                    snarest.</div>
